...
output_licitacoes = open("resultado/licitacoes_busca_gasolina_2015.csv", "w")
output_pregoes = open("resultado/pregoes_busca_gasolina_2015.csv", "w")
...
r = urllib2.urlopen("http://compras.dados.gov.br/licitacoes/v1/licitacoes.xml?objeto=paracetamol&data_publicacao_min=2014-01-01")
...
while offset < total_offset:
    ...
    r = urllib2.urlopen("http://compras.dados.gov.br/licitacoes/v1/licitacoes.xml?objeto=paracetamol&data_publicacao_min=2014-01-01&offset=%d" % offset)
    content = r.read()
    r.close()
    tree = etree.fromstring(content)
    root = tree[1]
